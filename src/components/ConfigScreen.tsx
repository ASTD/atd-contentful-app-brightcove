    ...
    <>
      ...
      <div className={cardClassName}>
        <Form>
          ...
          <Paragraph>
            The Brightcove app is a widget that allows editors to select video
            from their Brightcove account. Select or upload a file on Brightcove
            and designate the assets that you want your entry to reference.
          </Paragraph>
          <hr />
          ...
          <FieldGroup>
             ...
             **/}
            <FormLabel htmlFor="proxyUrl" required>
              Proxy URL
            </FormLabel>
            <TextInput
              required
          ...
          <FieldGroup>
            <FormLabel htmlFor="accountId" required>
      ...
      <div className={logoClassName}>
        ...
        >
          <defs>
            <polygon
              id="path-1"
              points="3.2e-05 4.54747351e-15 31.99952 4.54747351e-15 31.99952 31.99952 3.2e-05 31.99952"
            ></polygon>
          </defs>
          <g
            id="Blue-Steel"
